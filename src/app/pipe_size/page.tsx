...
const WIRE_OPTIONS: Record<string, { sizes: string[]; cores: string[] | null }> = {
  // IVより線1.25/2/3.5は3110-8表・3115-8表に補正係数の記載がないためスコープ外（2026-06-07 別エージェント検証）
  'IV':       { sizes: ['1.6㎜', '2.0㎜', '2.6㎜', '3.2㎜', '5.5', '8', '14', '22', '38', '60', '100', '150', '200', '250', '325'], cores: null },
...
// 3110-8表・3115-8表: 単線1.6/2.0→2.0、単線2.6/3.2・より線5.5/8→1.2、より線14以上→1.0
// より線1.25/2/3.5は表に記載がないため対象外（IVサイズ選択肢からも除外済み）
const IV_CORR20 = new Set(['1.6㎜', '2.0㎜'])
