...
const DATA: Record<string, Record<string, Record<string, number>>> = {
  ...
  HIV: {
    ...
    '管内（3本以下）': { '1.25': 16, '2': 23, '3.5': 31, '5.5': 41, '8': 52, '14': 75, '22': 99, '38': 138, '60': 185, '100': 255, '150': 338, '200': 400, '250': 474, '325': 555 },
  },
  ...
  CV: {
    ...
    // 管路引入れ: 単心(CV) 4孔3条布設（p881）。原典は100mm²以上のみ。2〜60mm²は単心欄が「—」で規程に値なし＝スコープ外（2026-06-07 別エージェント検証）
    '管路引入れ': { '100': 310, '150': 390, '200': 460, '250': 520, '325': 600 },
